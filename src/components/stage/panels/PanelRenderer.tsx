...
export const PanelRenderer = () => {
    ...
    return (
        <Card className="bg-white/90 border border-gray-400 rounded p-2 text-sm" style={{
            position: 'absolute',
            ...
            <ActionButton action={MoveStageDefinition} args={{ x: activePanel.worldPos.x, y: activePanel.worldPos.y, z: activePanel.worldPos.z }} className="w-full"> Move </ActionButton>
        </Card>
    );
};
