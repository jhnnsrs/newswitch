...
export const ImagePlane = ({ image, index }: { image: ExpanseState["current_images"][0], index: number }) => {
    ...
    useLayoutEffect(() => {
        ...
        if (flatMatrix.length === 16) {
            ...
            const matrix = new Matrix4().set(
                ...
                flatMatrix[8],  flatMatrix[9],  flatMatrix[10] + index, flatMatrix[11],
            ...
            console.warn('[ImagePlane] Invalid affine matrix dimensions:', flatMatrix.length);
        }
