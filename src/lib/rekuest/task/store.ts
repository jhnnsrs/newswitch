...
import { getScopedTaskId, getScopedTaskReference } from './keys';
...
export interface TransportStore {
  ...
  setAssignationID: (appKey: string, reference: string, assignationId: string) => void;
  updateTask: (referenceOrId: string, updates: Partial<Task>, appKey?: string) => void;
  getTask: <TArgs = unknown, TReturn = unknown>(
    referenceOrId: string,
    appKey?: string,
  ) => Task<TArgs, TReturn> | undefined;
  removeTask: (referenceOrId: string, appKey?: string) => void;
  clearTasks: () => void;
}
  ...
  createStore<TransportStore>()(
    subscribeWithSelector(
      immer((set, get) => ({
        ...
        getTask: <TArgs = unknown, TReturn = unknown>(referenceOrId: string, appKey?: string) => {
          const state = get();
...
} = createScopedStoreHooks<TransportStore, ReturnType<typeof createTransportStore>>(
  'TransportStore',
);
...
export const selectTask =
  <TArgs = unknown, TReturn = unknown>(referenceOrId: string, appKey?: string) =>
